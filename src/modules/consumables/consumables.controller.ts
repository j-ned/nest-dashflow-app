...
export class ConsumablesController {
  ...
  async update(@CurrentUser() u: AuthUser, @Param('id') id: string, @Body() body: Record<string, unknown>) {
    ...
    if ('unitPrice' in patch && patch.unitPrice !== undefined && patch.unitPrice !== null) {
    ...
    if ('estimatedLifetimeDays' in patch && patch.estimatedLifetimeDays !== undefined && patch.estimatedLifetimeDays !== null) {
